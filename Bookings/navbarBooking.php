    ...
    <div class="navbar">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="createBooking.php">Book a trip</a>
                <a href="readBooking.php">See all bookings</a>
                <a href="updateBooking.php">Change your booking</a>
                <a href="deleteBooking.php">Delete your booking</a>
                <a href="searchBooking.php">Search your booking</a>
